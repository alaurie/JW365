...
public record TenantFeed(@JsonProperty("tenantId") String tenantId, @JsonProperty("tenantDisplayName") String tenantDisplayName, @JsonProperty("feedUrl") URI feedUrl) {
