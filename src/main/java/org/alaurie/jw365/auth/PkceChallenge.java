 ...
 *
 * @param codeVerifier The cryptographically random high-entropy secret
 *     verifier.
 * @param codeChallenge The SHA-256 base64url-encoded challenge sent in the
 *     authorize request.
...
public record PkceChallenge(String codeVerifier, String codeChallenge, String state) {
    ...
    /**
     * Generates a new cryptographically secure PKCE challenge with 64 random
     * bytes (86 chars base64url).
     *
